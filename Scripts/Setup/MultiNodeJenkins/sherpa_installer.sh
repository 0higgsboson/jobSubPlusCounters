...
cp -r ${sherpa_repo_dir}/source/jobSubPlusCounters   ${sherpa_src_dir}/

cp -r ${sherpa_repo_dir}/source/hiveClientSherpa   ${hive_client_src_dir}/

cp -r ${sherpa_repo_dir}/source/mrClient   ${mr_client_src_dir}/

cp  ${sherpa_repo_dir}/source/hadoop-2.6.0-src.tar.gz   ${hadoop_src_dir}/
