...
print "ClientSeqNo\tOriginator\tState\tSherpaTuned\tLatency\tMemory\tCPU"
for job in cursor:
#     print "---------------------------------------------------------------------"
#     print "ClientSeqNo: ", job['clientSeqNo']
#     print "Originator: ", job['originator']
#     print "State: ", job['state']
     s = str(job['clientSeqNo']) + "\t\t" + job['originator'] + "\t\t" + job['state'] + "\t"
     if 'conf' in job:
          config = job['conf']
#          print config
...
#          print "Sherpa Tuned: ", job['jobMetaData']['sherpaTuned']
          execution_time = job['jobMetaData']['executionTime']
          s += job['jobMetaData']['sherpaTuned'] + "\t\t" + str(execution_time) + "\t" + str(mem) + "\t" + str(cpu)
          print s
#     print
