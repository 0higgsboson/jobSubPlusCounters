...
public class HiBenchJobIdExtractor extends  Thread{
    private static final Logger log = LoggerFactory.getLogger(HiBenchJobIdExtractor.class);

    private HiBenchJobExecutor hiveJobExecutor;
    private Process process;


    public HiBenchJobIdExtractor(HiBenchJobExecutor hje, Process process){
